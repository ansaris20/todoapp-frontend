...
export default class TodoApp extends Component {
  ...
  render() {
    const { task, tasks, isLogged, errorMessage, filter, searchQuery } =
      this.state;
          ...
          <div className="TodoContainer">
            <div>
              <div className="d-flex justify-content-end">
                <h1 className="text-center message">
              ...
              <div className="container TodoCard">
                ...
                <ul className="list-group mt-3 list-card">
                  {filteredTasks.map((taskObj, index) => (
                    <li
                      className="list-group-item d-flex justify-content-between align-items-center list-card-container"
                      key={index}
                    >
                      <div className="task">
                        <input
                          ...
                          onChange={() =>
                            this.onTaskCheck(taskObj._id, !taskObj.isChecked)
                          }
                          style={{ marginRight: "10px" }}
                        />
                        <span
                          style={{
                            textDecoration: taskObj.isChecked
                              ? "line-through"
                              : "none",
                          }}
                        >
                      ...
                      <div>
                        <FontAwesomeIcon
                          icon={faTrashAlt}
                          onClick={() => this.onDelete(taskObj._id)}
